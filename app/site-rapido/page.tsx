    ...
    <div className="flex min-h-svh flex-col bg-slate-950">
      ...
      <main className="flex flex-1 flex-col justify-center py-2.5">
        ...
        <Section className="mt-6 sm:mt-10">
          <div className="-mx-4 flex snap-x snap-mandatory gap-3 overflow-x-auto scroll-px-4 px-4 pb-2 pt-3 scrollbar-hide md:mx-0 md:grid md:grid-cols-3 md:gap-4 md:overflow-visible md:px-0 md:pb-0 md:pt-0">
            <PlanCard
              title="Modelo Pronto"
              price="R$499,90"
